package com.example.mind_works.adapters;
...
import com.example.mind_works.NotesClickListener;
import com.example.mind_works.R;
...
public class Notes_list_adapter extends RecyclerView.Adapter<NotesViewHolder>{
    ...
    public Notes_list_adapter(Context context, List<Notes> list, NotesClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder holder, int position)
    {
        ...
        if(list.get(position).isPinned()){
            holder.imageViewPin.setImageResource(R.drawable.ic_baseline_push_pin_24);
        }
        else
        {
...
class NotesViewHolder extends RecyclerView.ViewHolder {
    ...
    TextView textViewNotes, textViewTitle, textViewDate;
